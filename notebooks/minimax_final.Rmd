...
ggsave("../plots/final/utility_case_1.png", width = 12, height = 8)
```
...
items %>%
  ...
  facet_wrap(. ~ lab, ncol = 1) +
  theme(legend.position = "none", axis.title = element_blank())
ggsave("../plots/final/utility_case_2.png", width = 12, height = 8)
```
...
items %>%
  ...
  facet_wrap(. ~ lab, ncol = 1) +
  theme(legend.position = "none", axis.title = element_blank())
ggsave("../plots/final/utility_case_3.png", width = 12, height = 8)
```
